...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_path",
        help="Path to text file with data for training the tokenizer",
        required=True)
    parser.add_argument(
        "--output_path_prefix",
        help="Path where to write the tokenizer info, if absent, nothing is written")
    parser.add_argument(
        "--vocab_size", help="Desired size of the vocabulary", type=int,
        required=True)
    parser.add_argument(
        "--max_chunk_bytes",
        ...
        default=20000000)
    parser.add_argument(
        "--num_workers", help="Number of workers for the pretokenization phase",
        type=int, default=1)
    parser.add_argument(
